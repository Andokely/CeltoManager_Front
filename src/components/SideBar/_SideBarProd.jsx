...
function _SideBarProd() {
    ...
    return (
        <div className='p-1'>
            <div className='fixed bg-red-800 h-[calc(100vh-10px)] animate-slideInLeft overflow-y-scroll w-72 rounded-xl transition-transform duration-300 xl:translate-x-0 px-1 py-1 flex flex-col justify-between scrollbar-thin'>
                <div className=''>
