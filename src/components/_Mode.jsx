            ...
            <div className='flex space-x-2 justify-center items-center'>
                ...
                <div className='flex justify-center items-center'>
                    <label className="inline-flex items-center relative cursor-pointer">
                        ...
                        />
                        <div className="relative w-[100px] h-[35px] bg-gray-200 peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[26px] after:h-[26px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[50px] peer-checked:after:left-[95px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"></div>
                        <svg
                            height="0"
                            width="100"
                            viewBox="0 0 24 24"
